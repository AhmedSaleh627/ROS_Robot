...
if("TRUE" STREQUAL "TRUE")
  set(esp32_peripherals_SOURCE_PREFIX /home/ahmedsaleh/Rostutorials_ws/src/my_ROS_mobile_robot/my_robot_scripts/esp32_scripts/esp32_peripherals)
  set(esp32_peripherals_DEVEL_PREFIX /home/ahmedsaleh/Rostutorials_ws/devel)
  ...
  set(esp32_peripherals_INSTALL_PREFIX /home/ahmedsaleh/Rostutorials_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'esp32_peripherals' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ahmedsaleh/Rostutorials_ws/src/my_ROS_mobile_robot/my_robot_scripts/esp32_scripts/esp32_peripherals/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(esp32_peripherals_EXPORTED_TARGETS ${${esp32_peripherals_dep}_EXPORTED_TARGETS})
endforeach()
